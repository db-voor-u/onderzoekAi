...
<body>
    ...
    <div class="container">
        ...
        <form action="/send-survey" method="POST">
            ...
            <label for="bedrijfsnaam">1 Wat is de naam van uw bedrijf?</label>
            <input type="text" id="bedrijfsnaam" name="bedrijfsnaam">

            <label for="sector">2 In welke sector bent u actief?</label>
            ...
            <label for="grootte">3 Hoe groot is uw bedrijf? (Aantal werknemers)</label>
            <input type="text" id="grootte" name="grootte">

            <label for="regio">4 Welke regio/gebied bedient uw bedrijf?</label>
            <input type="text" id="regio" name="regio">

            <!-- Sectie 2: Huidige Uitdagingen en Behoeften -->
            <label for="uitdagingen">5 Welke dagelijkse uitdagingen ervaart u in uw werk?</label>
            <textarea id="uitdagingen" name="uitdagingen"></textarea>

            <label for="technologieGebruik">6 Hoe gebruikt u op dit moment technologie in uw bedrijf?</label>
            <textarea id="technologieGebruik" name="technologieGebruik"></textarea>

            <label for="verbeteringTechnologie">7 Zijn er specifieke taken die u denkt te kunnen verbeteren met behulp van technologie?</label>
            <textarea id="verbeteringTechnologie" name="verbeteringTechnologie"></textarea>

            <!-- Sectie 3: Kennis en Houding ten opzichte van AI -->
            <label for="bekendAI">8 Bent u bekend met AI-technologieën?</label>
            <select id="bekendAI" name="bekendAI">
                <option value="ja">Ja</option>
                <option value="nee">Nee</option>
            </select>

            <label for="hulpAI">9 Hoe denkt u dat AI uw bedrijf kan helpen?</label>
            <textarea id="hulpAI" name="hulpAI"></textarea>

            <label for="zorgenAI">10 Heeft u enige terughoudendheid of zorgen met betrekking tot het gebruik van AI in uw bedrijf?</label>
            <textarea id="zorgenAI" name="zorgenAI"></textarea>

            <!-- Sectie 4: Potentiële Toepassingen van AI -->
            <label for="automatiseringAI">11 Welke taken binnen uw bedrijf zou u willen automatiseren of ondersteunen met AI?</label>
            <textarea id="automatiseringAI" name="automatiseringAI"></textarea>

            <label for="klantenserviceAI">12 Zou u geïnteresseerd zijn in AI-gestuurde klantenservicetools?</label>
            <select id="klantenserviceAI" name="klantenserviceAI">
                <option value="ja">Ja</option>
                <option value="nee">Nee</option>
            </select>

            <label for="planningAI">13 Zou u AI willen gebruiken voor het plannen en beheren van werkopdrachten?</label>
            ...
            <label for="investeringAI">14 Hoeveel bent u bereid te investeren in AI-technologie voor uw bedrijf?</label>
            ...
            <label for="aankoopType">15 Zoekt u naar een eenmalige aankoop of een abonnementsservice voor technologische hulpmiddelen?</label>
            ...
            <label for="belangrijkeFactoren">16 Welke factoren zijn voor u het belangrijkst bij het kiezen van een technologische oplossing?</label>
            <textarea id="belangrijkeFactoren" name="belangrijkeFactoren"></textarea>

            <!-- Sectie 6: Slotvragen -->
            <label for="suggesties">17 Heeft u suggesties of specifieke wensen voor AI-oplossingen in uw branche?</label>
            <textarea id="suggesties" name="suggesties"></textarea>

            <label for="interesseVervolgonderzoek">18 Zou u geïnteresseerd zijn in deelname aan een vervolgonderzoek of een demo van AI-oplossingen voor uw bedrijf?</label>
